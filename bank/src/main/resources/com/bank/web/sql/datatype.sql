-- SQL 은 데이터 타입이 총 3가지만 기억
-- 문자형 타입
-- char  고정 길이의 문자형 데이터, 최대 크기는 20000byte
-- varchar2  가변 길이의 문자형 데이터, 반드시 size 값 명시, 최대 크기는 40000byte
-- nchar  고정길이의 유니코드(UTF-8) 문자형 데이터, 최대 크기는 2000byte
